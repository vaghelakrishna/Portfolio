        ...
        <motion.div variants={itemVariants} className="mb-16 flex flex-col items-start">
          ...
          >
            ...
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-2 px-6 py-3 bg-white text-black hover:bg-gray-100 rounded-lg transition-colors"
            >
                ...
                <div className="flex-1 p-6">
                  ...
                  <div className="flex gap-3">
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="flex items-center gap-2 px-4 py-2 bg-gray-800 dark:bg-[#171717] hover:bg-gray-700 dark:hover:bg-[#171717]/80 rounded-lg text-sm transition-colors"
                    >
